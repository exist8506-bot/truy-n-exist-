...
(function(){
 ...
 window.KhoAPI={version:'1.6.2',base,getStories:(q='')=>request('/stories'+(q?'?q='+encodeURIComponent(q):'')),getBook:id=>request('/stories/'+encodeURIComponent(id)),getChapter:(id,i)=>request('/stories/'+encodeURIComponent(id)+'/chapters/'+i)};
})();
